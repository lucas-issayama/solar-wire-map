...
interface DialogLayoutTestCardProps {
  open: boolean;
...
export default function DialogLayoutTest({
  open,
  setOpen,
  setQuote,
  setQuoteKit,
  ...
  function calcAndAddLayoutItems() {
    if (structure) {
      ...
      itemsToAdd = getItemsFromStructure(
        structure,
        quoteKit?.layoutItems,
  ...
  return (
    quoteKit && (
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent className="max-w-[80%] max-h-[90%]  w-[1000px] m-0 p-0 overflow-scroll">
          {/* <DialogHeader>
            <DialogTitle>Layout dos módulos:</DialogTitle>
          </DialogHeader> */}
          {structure && (
          ...
          {/* {structure && <div className="p-10"></div>} */}
